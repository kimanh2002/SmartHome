  ...
  return (
    <View style={styles.contentContainer}>
      ...
      <ScrollView   style={styles.scrollView}>
        ...
        <View style={styles.square}>
          {/* Nút Độ ẩm */}
          <TouchableOpacity style={styles.device} onPress={handleHumidityButtonPress}>
            <Icon name="water-outline" size={50} color={colors.primary} />
            <Text style={styles.text}>Độ ẩm</Text>
          </TouchableOpacity>
          {/* Nút Khí gas */}
          <TouchableOpacity style={styles.device} onPress={handleGasButtonPress}>
        ...
        <View style={[styles.square, styles.squareBottom]}>
          ...
          {/* Nút Thêm thiết bị */}
          <TouchableOpacity style={styles.device} onPress={handleAddDeviceButtonPress}>
